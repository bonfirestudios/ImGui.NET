...
namespace NetImGuiNET
{
    public static unsafe partial class NetImGuiNative
    {
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern  bool NetImgui_IsConnected();
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern  bool NetImgui_IsConnectionPending();
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern  bool NetImgui_IsDrawingRemote();
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern  bool NetImgui_IsDrawing();
    }
}